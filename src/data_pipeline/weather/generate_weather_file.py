...
from src.data_pipeline.weather.utils_weather.gee_weather import get_df_weather_gee
...
def generate_weather_file(
    ...
    radiation, wind speed, vapour pressure, ET0) for a location from
    ERA5-Land daily on Google Earth Engine (see `gee_weather`) and write
    them as a CSV file.
