...
def train(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    if cfg.get("train"):
        ...
        # weights_only=False: our own checkpoints hold the hydra-instantiated net/optimizer
        # hyperparameters, which torch>=2.6's default weights_only=True refuses to unpickle.
